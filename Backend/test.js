...
async function testGenerateArtworkDescription() {
    try {
      const prompt = 'Write a 3-line description of an artwork similar to the Mona Lisa. Include when it was created, who created it, where it is displayed, and a brief explanation.';
      const result = await generateText(prompt);
  ...
  async function testGenerateTextWithImage() {
    try {
      ...
      const imageUrl = "https://th-thumbnailer.cdn-si-edu.com/PS_-41itjP_RxxAKEquSm3e_MOg=/1072x720/filters:no_upscale()/https://tf-cmsv2-smithsonianmag-media.s3.amazonaws.com/filer/Vincent-van-Gogh-Doctor-Gachet-631.jpg";
...
async function runTests() {
  // await testGenerateArtworkDescription();
