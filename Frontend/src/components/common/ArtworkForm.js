...
// const ArtworkForm = ({ onSubmit, onDelete, onSuccess, initialData = {}, formType }) => {
//   const {
//     register,
//     handleSubmit,
//     formState: { errors },
...
//     if (initialData) {
//       Object.keys(initialData).forEach((key) => {
//         // If the key is 'createdDateByArtist', make sure to split it correctly
//         if (key === "createdDateByArtist" && initialData[key]) {
//           setValue(key, initialData[key].split("T")[0]); // Set the date correctly
//         } else {
//           setValue(key, initialData[key]);
...
//     await onSubmit(data);
//     if (onSuccess) {
//       onSuccess();  // Close form or navigate on success
//     }
//   };

//   return (
//     <div className="max-w-md mx-auto mt-10 p-4 border rounded-lg shadow-md">
//       <h2 className="text-2xl font-bold mb-4">{formType === "edit" ? "Edit Artwork" : "Create New Artwork"}</h2>
//       <form onSubmit={handleSubmit(handleFormSubmit)}>
//         <div className="mb-4">
...
//           />
//           {errors.createdDateByArtist && (
//             <p className="text-red-500 text-xs italic">Please enter the created date by the artist.</p>
//           )}
//         </div>
...
//             dialogMessage={`Are you sure you want to ${formType === "edit" ? "update" : "create"} this artwork?`}
//             className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
//           />
//           {formType === "edit" && (
//             <FormConfirmButton
