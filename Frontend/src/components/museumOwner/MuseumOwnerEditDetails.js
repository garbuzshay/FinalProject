    ...
    <div className='mx-8'>
      <div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`${isDarkMode ? "text-blue-400 hover:text-blue-500 underline block text-center mb-4" : "text-blue-600 hover:text-blue-800 underline block text-center mb-4"}`}
        >
          {t.visitMuseum}
        </a>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={`p-6 rounded-lg shadow-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-200"}`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Name */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="name">
                {t.museumName}
              </label>
              <input
                type="text"
                ...
                defaultValue={museum?.name}
                readOnly
                className={`mt-2 w-full p-3 border rounded-md shadow-sm focus:outline-none focus:ring-2 ${isDarkMode ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200 focus:ring-blue-500" : "border-gray-300 bg-white placeholder-gray-400 text-gray-900 focus:ring-blue-500"}`}
              />
              {errors.name && (
            ...
            {/* Address */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="address">
                {t.address}
              </label>
              <input
                type="text"
            ...
            {/* City */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="city">
                {t.city}
              </label>
              <input
                type="text"
            ...
            {/* State */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="state">
                {t.state}
              </label>
              <input
                type="text"
            ...
            {/* Zipcode */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="zipcode">
                {t.zipcode}
              </label>
              <input
                type="text"
            ...
            {/* Phone Number */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="phoneNumber">
                {t.phoneNumber}
              </label>
              <input
                type="text"
            ...
            {/* Email */}
            <div>
              <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="email">
                {t.email}
              </label>
              <input
                type="email"
          ...
          {/* Image URL and Preview */}
          <div className="mb-6">
            <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="imageUrl">
              {t.imageUrl}
            </label>
            <div className="flex items-center space-x-4 mt-2">
              <input
                ...
                {...register('imageUrl')}
                defaultValue={museum?.imageUrl}
                className={`w-full p-3 border rounded-md shadow-sm focus:outline-none focus:ring-2 ${isDarkMode ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200 focus:ring-blue-500" : "border-gray-300 bg-white placeholder-gray-400 text-gray-900 focus:ring-blue-500"}`}
              />
              {imageUrl && (
                <img src={imageUrl} alt="Current" className="w-20 h-20 object-cover rounded-md shadow-lg" />
              )}
            </div>
            {errors.imageUrl && (
          ...
          {/* Password and Generate Button */}
          <div className="mb-6">
            <label className={`block text-lg font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`} htmlFor="password">
              {t.password}
            </label>
            <div className="flex items-center space-x-4 mt-2">
              <input
              ...
              <button
                type="button"
                onClick={generateRandomPassword}
                className={`bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 shadow-md ${isDarkMode ? "focus:ring-blue-500" : "focus:ring-blue-500"} focus:outline-none focus:ring-2 transition-colors duration-300`}
              >
                {t.generatePassword}
              </button>
            </div>
