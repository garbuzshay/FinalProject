...
const MuseumOwnerEditExhibition = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { museum, exhibitions, updateExhibition, closeExhibition } = useMuseumContext();
  const [loading, setLoading] = useState(false);
  const [showCuratorSelect, setShowCuratorSelect] = useState(false);
  const [error, setError] = useState(null);
  const { isDarkMode } = useThemeMode(); // Destructure isDarkMode
  ...
  const onSubmit = async (data) => {
    ...
    const updatedData = {
      ...rest,
      curators: curators.map((curator) => curator.id),
      newCurators: newCurators.filter((curator) => curator.name && curator.email),
    };
        ...
        >
          ...
          <div className="mb-4">
            <label className={`block text-sm font-bold mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
              ...
              <input
                ...
                className={`mt-2 w-full p-3 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 ${
                  isDarkMode ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200" : "border-gray-300 bg-white placeholder-gray-400 text-gray-900"
                }`}
              />
              {errors.name && (
          ...
          <div className="mb-4">
            <label className={`block text-sm font-bold mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
              ...
              />
              {errors.maxArtworks && (
                <span className="text-red-500 text-sm mt-1">{errors.maxArtworks.message}</span>
              )}
            </label>
          </div>
              ...
              >
                <div>
                  ...
                  {field.isEditable ? (
                    <input
                      type="text"
                      {...register(`newCurators.${index}.name`, { required: t.curatorName })}
                      className={`mt-1 block w-full rounded-md border ${
                        isDarkMode
                          ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200"
                          : "border-gray-300 bg-white placeholder-gray-400 text-gray-900"
                  ...
                  {errors.newCurators?.[index]?.name && (
                    <span className="text-red-500 text-sm mt-1">{errors.newCurators[index]?.name?.message}</span>
                  )}
                </div>
                <div>
                  <label className={`block text-sm font-bold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                  ...
                  {field.isEditable ? (
                    <input
                      type="text"
                      {...register(`newCurators.${index}.lastName`, { required: t.curatorSurname })}
                      className={`mt-1 block w-full rounded-md border ${
                        isDarkMode
                          ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200"
                          : "border-gray-300 bg-white placeholder-gray-400 text-gray-900"
                  ...
                  {errors.newCurators?.[index]?.lastName && (
                    <span className="text-red-500 text-sm mt-1">{errors.newCurators[index]?.lastName?.message}</span>
                  )}
                </div>
                <div>
                  <label className={`block text-sm font-bold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                  ...
                  {errors.newCurators?.[index]?.email && (
                    <span className="text-red-500 text-sm mt-1">{errors.newCurators[index]?.email?.message}</span>
                  )}
                </div>
                <div>
                  <label className={`block text-sm font-bold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                  ...
                  {field.isEditable ? (
                    <input
                      type="tel"
                      {...register(`newCurators.${index}.phoneNumber`, { required: t.curatorPhone })}
                      className={`mt-1 block w-full rounded-md border ${
                        isDarkMode
                          ? "border-gray-700 bg-gray-700 placeholder-gray-500 text-gray-200"
                          : "border-gray-300 bg-white placeholder-gray-400 text-gray-900"
                  ...
                  {errors.newCurators?.[index]?.phoneNumber && (
                    <span className="text-red-500 text-sm mt-1">{errors.newCurators[index]?.phoneNumber?.message}</span>
                  )}
                </div>
                <div className="flex justify-end sm:justify-center items-center">
                  <button
          ...
          <div>
            {error && (
              <p className="text-red-500 text-center">{error.response?.data?.message || error.message}</p>
            )}
          </div>
