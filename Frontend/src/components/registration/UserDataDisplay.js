        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
              ...
              <CardContent>
                ...
                <Divider />
                <Typography variant="body1"><strong>Plan:</strong> {getPlanNameById(userData.plan)}</Typography>
                <Typography variant="body1"><strong>Price:</strong> {getPlanPriceById(userData.plan)}</Typography>
                <Typography variant="body1"><strong>Card Number:</strong> {maskCardNumber(userData.cardNumber)}</Typography>
                <Typography variant="body1"><strong>Expiry Date:</strong> {userData.expiryDate}</Typography>
                <Typography variant="body1"><strong>CVV:</strong> {maskCVV(userData.cvv)}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12}>
